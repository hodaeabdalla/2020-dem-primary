...
# I piped the clean data into a ggplot with all four combinations # of relationships. I made a scatter plot because it is the best  # method to show correlation. I used geom_smooth to add a  #regression line.
 ...
 # I used plot_grid from the cowplot package to place the plots side by side.
  ...
  # I made linear regression models for all four combinations to #get the correlation coefficients for analysis.
